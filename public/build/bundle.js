...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 161, 2, 4330);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    ...
    function create_if_block(ctx) {
    	...
    	let particleselector_props = { colors: /*COLORS*/ ctx[15] };
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(div5, h21);
    			append_dev(div5, t12);
    			mount_component(particleselector, div5, null);
    ...
    function create_if_block_2(ctx) {
    	...
    	function particleselector_selectedId_binding_1(value) {
    		/*particleselector_selectedId_binding_1*/ ctx[21](value);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file, 122, 4, 3450);
    			attr_dev(div, "class", "controls-block svelte-kjw3bp");
    			add_location(div, file, 121, 3, 3417);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h2);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 77, 0, 2222);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
